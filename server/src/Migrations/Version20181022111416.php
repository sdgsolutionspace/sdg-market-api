 ...
 */
final class Version20181022111416 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX fk_transaction_project_participation1_idx ON transaction');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX fk_transaction_project_participation1_idx ON transaction (project_participation_id)');
    }
}
